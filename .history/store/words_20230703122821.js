...
export const wordsSlice = createSlice({
  ...
  reducers: {
    update: (state, action) => {
      ...
      const wordState = wordListState.words.findIndex((wordInList) => {
        console.log(wordInList.word === action.payload.wordObject.word);
        return wordInList.word === action.payload.word;
      });
