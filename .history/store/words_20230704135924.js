...
const initialState = {
  learningList: {
    ...
    description:
      "Your learning list consists of the words that you are still learning, a word will be removed from this list if you have gotten it right twice in a row. Get it right one more time in its respected list and the word will be completed!",
    words: [],
  },
  completedList: [],
  wordLists: [
